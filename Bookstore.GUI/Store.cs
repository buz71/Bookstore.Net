    ...
    public static class Store
    {
        ...
        public static void AddToBasket(MainPage mainPage, Cart cart)
        {
            ...
            foreach (BookItem bookItem in bookItems)
            {
                ...
                CartItem cartItem = new CartItem(bookItem.Id, bookItem.BookName, bookItem.Author, bookItem.Year, bookItem.Price, bookItem.Quantity, bookItem.Action, bookItem.Tag);
                cart.StackPanel_Basket.Children.Add(cartItem);
